...
.. code-block:: bash
    ...
    .  generate_coords
    .  count_points_0
    creating:  /staging/approx_pi/count_points_0/tmp
    creating:  /staging/approx_pi/count_points_1/tmp
    creating:  /staging/approx_pi/count_points_3/tmp
    .  count_points_1
    .  count_points_2
    creating:  /staging/approx_pi/count_points_2/tmp
    .  count_points_3
    .  approx_pi
    creating:  /staging/approx_pi/approx_pi/tmp
    3.14219
